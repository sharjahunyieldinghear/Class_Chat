...
IL_003b:
	...
	}
	{
		...
		uint32_t L_18 = V_4;
		IL2CPP_RUNTIME_CLASS_INIT(Marshal_tEBAFAE20369FCB1B38C49C4E27A8D8C2C4B55058_il2cpp_TypeInfo_var);
		Marshal_Copy_m057A8067BF7212A361510EA26B24022990A07AC0((intptr_t)L_16, L_17, 0, L_18, /*hidden argument*/NULL);
	}
...
IL_0072:
	...
	}
	{
		...
		uint32_t L_24 = V_6;
		IL2CPP_RUNTIME_CLASS_INIT(Marshal_tEBAFAE20369FCB1B38C49C4E27A8D8C2C4B55058_il2cpp_TypeInfo_var);
		Marshal_Copy_m057A8067BF7212A361510EA26B24022990A07AC0((intptr_t)L_21, L_22, L_23, L_24, /*hidden argument*/NULL);
	}
...
IL_008b:
	{
		...
		PlayerConnection_t4A5AAC39753FEC33854C3478DD55863FDF2788B3 * L_28;
		L_28 = PlayerConnection_get_instance_mA46C9194C4D2FE0BB06C135C4C0521DD516592F6(/*hidden argument*/NULL);
		Guid_t  L_29 = ((RuntimeDebuggerOpenXRFeature_tE0D0BEE876CB547A518EF73B7596C17F6A507B32_StaticFields*)il2cpp_codegen_static_fields_for(RuntimeDebuggerOpenXRFeature_tE0D0BEE876CB547A518EF73B7596C17F6A507B32_il2cpp_TypeInfo_var))->get_kPlayerToEditorSendDebuggerOutput_17();
		ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* L_30 = V_7;
		NullCheck(L_28);
		PlayerConnection_Send_m51137877D6E519903AEA4A506ABD48A30AF684F0(L_28, L_29, L_30, /*hidden argument*/NULL);
		// }
		return;
	}
}
